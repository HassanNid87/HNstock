    ...
    <div class="container">
        ...
        <form action="{{ route('payments.update', $payment->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="Npayment" id="Npayment" class="form-control" value="{{ $payment->Npayment }}"
                       readonly required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="montant" id="montant" class="form-control" step="0.01"
                       value="{{ $payment->montant }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" name="date_payment" id="date_payment" class="form-control"
                       value="{{ $payment->date_payment->format('Y-m-d') }}" required>
            </div>

            <!-- Mode de paiement -->
            <div class="mb-3">
                <label for="mode_payment" class="form-label">Mode de Paiement</label>
                <input type="text" name="mode_payment" id="mode_payment" class="form-control"
                       value="{{ $payment->mode_payment }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <table class="table">
                    ...
                    @foreach ($payment->details as $detail)
                        <tr>
                            <td>
                                <input class="form-check-input" type="checkbox" name="sales[]" value="{{ $detail->id }}"
                                       data-amount="{{ $detail->montant_restant }}" id="sale{{ $detail->id }}">
                            </td>
                            <td>{{ $detail->NFact }}</td>
