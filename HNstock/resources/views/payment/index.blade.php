            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <form method="get" id="dateFilterForm" action="{{ url()->current() }}"
                        ...
                        <div class="input-daterange input-group w-100" id="datepicker6" data-date-format="yyyy-mm-dd"
                             data-date-autoclose="true">
                            <input type="text" class="form-control text-start form-control-sm" placeholder="From"
                                   name="start_date" id="start_date" value="{{ request('start_date') }}"
                                   autocomplete="off" autocorrect="off">
                            <input type="text" class="form-control text-start form-control-sm" placeholder="To"
                                   name="end_date" id="end_date" value="{{ request('end_date') }}" autocomplete="off"
                                   autocorrect="off">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form method="get" id="clientForm" class="d-flex align-items-center">
                                <input type="search" name="code" id="code" class="form-control form-control-sm w-100"
                                       placeholder="Code Client" value="{{ request('code') }}"
                        ...
                        <div class="col-md-6">
                            <form method="get" id="searchForm" class="d-flex align-items-center">
                                <input type="search" name="Npayment" id="Npayment"
                                       class="form-control form-control-sm w-100"
                                       placeholder="N° Réglement" value="{{ Request::input('Npayment') }}"
                                       aria-controls="DataTables_Table_0">
                            </form>
                        </div>
                    </div>
                                ...
                                <table class="table table-centered datatable dt-responsive nowrap table-card-list dataTable no-footer dtr-inline"
                                    ...
                                    <tr class="bg-transparent" role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            aria-label="Invoice ID: activate to sort column ascending">N° Régelement
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            aria-label="Amount: activate to sort column ascending">Montant
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 105px;"
                                            aria-label="Status: activate to sort column ascending">Mode Régl
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 127px;"
                                            aria-label="Download Pdf: activate to sort column ascending">Download Pdf
                                        </th>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="sorting_1">
                                                <a href="javascript: void(0);"
                                                   class="text-dark fw-bold">#{{ $payment->Npayment ?? 'N/A' }}</a>
                                            </td>
                    ...
                    <form method="get" action="{{ url()->current() }}" id="filterForm">
                        <div class="form-group d-flex flex-wrap">
                            <div class="form-check me-3">
                                <input type="checkbox" name="mode_payment[]" value="Espèce" id="mode_payment_Espèce"
                                       class="form-check-input" {{ in_array('Espèce', Request::input('mode_payment', [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="mode_payment_Espèce">Espèce</label>
                            </div>
                            <div class="form-check me-3">
                                <input type="checkbox" name="mode_payment[]" value="Chèque" id="mode_payment_Chèque"
                                       class="form-check-input" {{ in_array('Chèque', Request::input('mode_payment', [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="mode_payment_Chèque">Chèque</label>
                            </div>
                            <div class="form-check me-3">
                                <input type="checkbox" name="mode_payment[]" value="VirBancaire"
                                       id="mode_payment_VirBancaire"
                                       class="form-check-input" {{ in_array('VirBancaire', Request::input('mode_payment', [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="mode_payment_VirBancaire">Virement Bancaire</label>
                            </div>
                            <div class="form-check me-3">
                                <input type="checkbox" name="mode_payment[]" value="Carte de Crédit"
                                       id="mode_payment_Carte"
                                       class="form-check-input" {{ in_array('Carte de Crédit', Request::input('mode_payment', [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="mode_payment_Carte">Carte de Crédit</label>
                            </div>
                            <div class="form-check me-3">
                                <input type="checkbox" name="mode_payment[]" value="Autre" id="mode_payment_Autre"
                                       class="form-check-input" {{ in_array('Autre', Request::input('mode_payment', [])) ? 'checked' : '' }}>
