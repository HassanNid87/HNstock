                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="Npayment" id="Npayment" class="form-control"
                                                   value="{{ old('Npayment', $payment->Npayment) }}" readonly required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="date_payment" id="date_payment"
                                                   class="form-control"
                                                   value="{{ old('date_payment', $payment->date_payment ? $payment->date_payment->format('Y-m-d') : '') }}"
                                                   required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="montant" id="montant" class="form-control"
                                                   step="0.01" value="{{old('montant',$payment->montant)}}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
