                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form method="get" id="clientForm" class="d-flex align-items-center">
                                <input type="search" name="code" id="code" class="form-control form-control-sm w-100"
                                       placeholder="Client Code" value="{{ Request::input('code') }}"
                        ...
                        <div class="col-md-6">
                            <form method="get" id="searchForm" class="d-flex align-items-center">
                                <input type="search" name="NFacture" id="NFacture"
                                       class="form-control form-control-sm w-100"
                                       placeholder="N° Facture" value="{{ Request::input('NFacture') }}"
                                       aria-controls="DataTables_Table_0">
                            </form>
                        </div>
                    </div>
                                ...
                                <table class="table table-centered datatable dt-responsive nowrap table-card-list dataTable no-footer dtr-inline"
                                    ...
                                    <tr class="bg-transparent" role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            aria-label="Invoice ID: activate to sort column ascending">N°Fact
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            aria-label="Billing Name: activate to sort column ascending">Client
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 77px;"
                                            aria-label="Amount: activate to sort column ascending">M TTC
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 65px;"
                                            aria-label="Status: activate to sort column ascending">Statut
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 77px;"
                                            aria-label="reste: activate to sort column ascending">Reste
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 127px;"
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="sorting_1">
                                                <a href="javascript: void(0);"
                                                   class="text-dark fw-bold">#{{ $sale->NFact }}</a></td>
                                            <td>{{ $sale->DateFact }}</td>
                                            <td> @if ($sale->client)
                                                    <a href="{{ route('clients.show', $sale->client_id) }}"
                                                       class="btn btn-link">
                    ...
                    <form method="get" action="{{ url()->current() }}" id="filterForm">
                        <div class="form-group d-flex flex-wrap">
                            <div class="form-check me-3">
                                <input type="checkbox" name="status[]" value="EnAttente" id="status_enattente"
                                       class="form-check-input" {{ in_array('EnAttente', Request::input('status', [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="status_enattente">EnAttente</label>
                            </div>
                            <div class="form-check me-3">
                                <input type="checkbox" name="status[]" value="PartPayée" id="status_partpayee"
                                       class="form-check-input" {{ in_array('PartPayée', Request::input('status', [])) ? 'checked' : '' }}>
                                <label class="form-check-label" for="status_partpayee">PartPayée</label>
                            </div>
                            <div class="form-check me-3">
                                <input type="checkbox" name="status[]" value="Réglée" id="status_reglee"
                                       class="form-check-input" {{ in_array('Réglée', Request::input('status', [])) ? 'checked' : '' }}>
