...
@section('content')
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="card">
                <a href="#client-info-collapse" class="text-dark" data-bs-toggle="collapse" aria-expanded="true"
                   aria-controls="client-info-collapse">
                    <div class="p-4">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                ...
                                <p class="text-muted text-truncate mb-0">Remplissez les informations principales du
                                    client</p>
                            </div>
                ...
                <div id="client-info-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                    <div class="p-4 border-top">
                        <form action="{{ $isUpdate ? route('clients.update', $client) : route('clients.store') }}"
            ...
            <div class="card mt-4">
                <a href="#client-contact-collapse" class="text-dark" data-bs-toggle="collapse" aria-expanded="false"
                   aria-controls="client-contact-collapse">
                    <div class="p-4">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-xs">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="url" name="siteweb" id="siteweb" class="form-control"
                                           value="{{ old('siteweb', $client->siteweb) }}">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card mt-4">
                <a href="#client-extra-collapse" class="text-dark" data-bs-toggle="collapse" aria-expanded="false"
                   aria-controls="client-extra-collapse">
                    <div class="p-4">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-xs">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div id="photo-preview" class="mt-2"
                                         style="{{ !$client->photo ? 'display:none;' : '' }}">
                                        @if ($client->photo)
                                            <img width="100" src="{{ asset('storage/' . $client->photo) }}"
                                                 alt="Client Photo" id="photo-preview-img">
                                        @else
                                            <img width="100" src="" alt="Client Photo" id="photo-preview-img"
                                                 style="display:none;">
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="soldemax" id="soldemax" class="form-control" step="0.01"
                                           value="{{ old('soldemax', $client->soldemax) }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="mb-0">
                                ...
                                <textarea name="description" id="description" placeholder="Notes"
