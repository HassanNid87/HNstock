                        ...
                        <div class="p-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <p class="text-muted text-truncate mb-0">Affichage des produits sous forme de
                                        tableau détaillé</p>
                                </div>
                                                        ...
                                                        @forelse ($products as $product)
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td><a href="javascript: void(0);"
                                                                       class="text-dark fw-bold">{{ $product->name }}</a>
                                                                </td>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-5">
                                                    <div class="dataTables_info" id="DataTables_Table_0_info"
                                                         role="status" aria-live="polite">Showing 1 to 10 of 12 entries
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="dataTables_paginate paging_simple_numbers"
                                                        ...
                                                        <ul class="pagination">
                                                            ...
                                                            <li class="paginate_button page-item next"
                                                                ...
                                                                <a href="#" aria-controls="DataTables_Table_0"
                                                                   data-dt-idx="3" tabindex="0" class="page-link">Next
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="card h-100" style="max-width: 200px; padding: 6px;">
                                            ...
                                            <div class="card-body" style="padding: 3px;">
                                                <h6 class="card-title"
                                                    style="font-size: 0.875rem;">{{ $product->name }}</h6>
                                                <p class="card-text"
                                        ...
                                        <span style="font-size: 0.85rem;">
                                            ...
                                            <div class="card-footer" style="padding: 3px;">
                                                <div class="d-flex align-items-center">
                                                    <button type="button"
                                                            class="btn btn-outline-primary quantity-decrease"
                                                    ...
                                                    <input type="number" id="quantity-{{ $product->id }}"
                                                           name="quantity"
                                                           min="1"
                                                           max="{{ $product->stock ? $product->stock->quantity : 1 }}"
                                                           value="1"
                                                           class="form-control mx-2"
                                                           style="max-width: 60px; font-size: 0.75rem; text-align: center;">

                                                    <button type="button"
                                                            class="btn btn-outline-primary quantity-increase"
                                                            style="padding: 2px 5px; font-size: 0.75rem;">
                                                        +
                                                    </button>
