                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="priceA" placeholder="Prix d'Achat" step="0.01"
                                                   id="priceA" class="form-control"
                                                   value="{{ old('priceA', $product->priceA) }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            <label class="form-label" for="priceV">Prix de vente</label>
                                            <input type="number" name="priceV" id="priceV" placeholder="Prix de vente"
                                                   step="0.01" class="form-control"
                                                   value="{{ old('priceV', $product->priceV) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-0">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="codebare" id="codebare" placeholder="Code Barre"
                                                   class="form-control"
                                                   value="{{ old('codebare', $product->codebare) }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="etagere" id="etagere" placeholder="Étagère"
                                                   class="form-control" value="{{ old('etagere', $product->etagere) }}">
                                        </div>
                                    </div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <p class="text-muted text-truncate mb-0">cliquer et télécharger l'image de
                                        produit</p>
                                </div>
                                <div class="flex-shrink-0">
                                    <i class="mdi mdi-chevron-up accor-down-icon font-size-24"></i>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div id="image-container" class="mb-3"
                                                ...
                                                <img id="image-preview" width="100px"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="stockmax" id="stockmax" class="form-control"
                                                   value="{{ old('stockmax', $product->stockmax) }}">
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="stockmin" id="stockmin" class="form-control"
                                                   value="{{ old('stockmin', $product->stockmin) }}">
                                        </div>
                                    </div>
                                </div>
